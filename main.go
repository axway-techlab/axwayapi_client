...
func main() {
	...
	user := createUser(org.Id)
	defer deleteUser(user)

	err = c.SetPassword(user.Id, "Password123")
	if err != nil {
		panic(err)
	}
...
func updateOrg(org *axwayapi.Org) {
	...
	println("### UPDATE IMAGE ###")
	err = client.UpdateOrgImage(org.Id, "")
	if err != nil {
		panic(err)
	}
}
